...
// require_once('tcpdf/tcpdf.php');  
              ...
              <hr></hr>
              <h4 align="center">List Data Dokter</h4><br /> 
              ...
              $content .= ' <tr>  
                                <td>'.$datadokter->kd_dokter.'</td>
                                <td>'.$datadokter->nama_dokter.'</td>  
                                <td>'.$datadokter->jk_dokter.'</td>
                                <td>'.$datadokter->tlp_dokter.'</td>
                                <td>'.$datadokter->hari_dokter.'</td>
                                <td>'.$datadokter->jam_dokter.'</td>
                            </tr>  
                            ';    
                        }  
              $content .= '</table>';  
